...
class TableOfContentFragment : Fragment(), TOCCallback {
    ...
    override fun onCreateView(inflater: LayoutInflater,
        ...
        mBookTitle = arguments!!.getString(Constants.BOOK_TITLE)
        if (mConfig!!.isNightMode) {
            mRootView.findViewById<View>(R.id.recycler_view_menu).setBackgroundColor(ContextCompat.getColor(activity!!,
                    R.color.black))
        }
        return mRootView
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        mTableOfContentsRecyclerView = view.findViewById<View>(R.id.recycler_view_menu) as RecyclerView
    ...
    fun configRecyclerViews() {
        ...
        mTableOfContentsRecyclerView!!.layoutManager = LinearLayoutManager(activity, LinearLayoutManager.VERTICAL, false)
        mTableOfContentsRecyclerView!!.addItemDecoration(DividerItemDecoration(activity, DividerItemDecoration.VERTICAL))
    }
    ...
    fun onLoadTOC(tocLinkWrapperList: ArrayList<TOCLinkWrapper>?) {
        mTOCAdapter = TOCAdapter(activity, tocLinkWrapperList,
                arguments!!.getString(Constants.SELECTED_CHAPTER_POSITION), mConfig)
    ...
    companion object {
        fun newInstance(publication: Publication?,
                        selectedChapterHref: String?, bookTitle: String?): TableOfContentFragment {
